function Hero() {
  return (
    <div className="container">
      ...
      <div className="row p-3 p-md-5 mb-4 mb-md-5 mt-4 mt-md-5">
      ...
      <div className="row p-3 p-md-5 mt-4 mt-md-5 border-top">

   
        <div className="col-12 col-lg-6 lh-lg p-2 p-md-4 text-muted">
